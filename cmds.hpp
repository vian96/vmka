...
_CMD_DEF_(ADD, 3, 3, {}, {_PUSH_VAR_ _PUSH_VAR_})
...
_CMD_DEF_(JE, 7, 7, {int lhs=_POP_VAR_VAL_; int rhs=_POP_VAR_VAL_; if (lhs==rhs) _DO_JMP_}, {_PUSH_VAR_ _PUSH_VAR_ _PUSH_LABEL_OFFSET_})
